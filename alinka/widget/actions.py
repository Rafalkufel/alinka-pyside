...
def generate_and_save_decision(form_data: DocumentData, generate: bool = False, destination_path: str = "") -> None:
    ...
    decision_data = DecisionDbSchema(
        ...
        is_first_parent_address_different=form_data.is_first_parent_address_different,
        is_second_parent_address_different=form_data.is_second_parent_address_different,
